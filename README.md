...
| 上传时间       | 标题                                         | 资料                                                                                 | 视频地址                                                 | 说明                                  |
| ---------- | ------------------------------------------ | ---------------------------------------------------------------------------------- | ---------------------------------------------------- | ----------------------------------- |
| 2022.03.31 | T1 Python安装和Jupyter使用                      | [资料获取](Teaching/"T1 Python安装和Jupyter使用")                                             | [B站地址](https://www.bilibili.com/video/BV1B44y1P7Je)  | 学Python第一个视频                        |
| 2022.04.05 | T2 用Pandas分析Tushare上市公司信息                  | [资料获取]("Teaching/T2 用Pandas分析Tushare上市公司信息")                                         | [B站地址](https://www.bilibili.com/video/bv1a3411H7kP)  | 免费金融数据介绍                            |
| 2022.04.19 | T3 Python语法基础——以复现经济数据报告为例                 | [资料获取]("Teaching/T3 Python语法基础——以经济数据报告为例")                                          | [B站地址](https://www.bilibili.com/video/BV1HY4y1v7Ke/) | Python语法基础                          |
| 2022.05.09 | T4 Python文件系统——高效管理投行申报目录                  | [资料获取]("Teaching/T4 Python文件系统操作——以高效管理投行申报目录为例")                                    | [B站地址](https://www.bilibili.com/video/BV1y5411d7j1/) | 一个综合的知识锻炼                           |
| 2022.05.26 | T5 Numpy+Pandas+Matplotlib——用Python绘制股票K线图 | [资料获取]("Teaching/T5 N.P.M.数据分析三剑客——用Python绘制股票K线图")                                  | [B站地址](https://www.bilibili.com/video/BV1kS4y1z7JH/) | 三剑客在手，数据分析随便走                       |
| 2022.07.21 | T6 Python股票K线查询网页开发——HTML和Flask实操          | [资料获取]("Teaching/T6 Python网站编程基础——股票K线查询网页开发")                                       | [B站地址](https://www.bilibili.com/video/BV17Y4y1j7NB)  | Python前后端基础                         |
| 2022.11.18 | T7 Python网络爬虫——使用东财金融数据进行杜邦分析              | [资料获取]("Teaching/T7 Python网络爬虫——使用东财金融数据进行杜邦分析")                                     | [B站地址](https://www.bilibili.com/video/BV1k8411j7tx/) | Python爬虫实战+金融财务知识                   |
| 2023.1.8   | T8 Python自动化Word——自动生成上市公司年报分析             | [资料获取]("Teaching/T8 Python自动化Word——自动生成上市公司年报分析")                                    | [B站地址](https://www.bilibili.com/video/BV1MK41117vE/) | Python自动化word操作+上市公司年报分析            |
| 2023.1.19  | T9 Python自动化Excel——自动进行企业营收战略规划            | [资料获取]("Teaching/T9 Python自动化Excel——自动进行企业营收战略规划")                                   | [B站地址](https://www.bilibili.com/video/BV1VG4y1F7fa/) | Python自动化excel操作+战略规划预测方法           |
| 2023.2.2   | T10 Python数据库基础操作——基于Akshare存储股票行情数据       | [资料获取]("Teaching/T10 Python数据库基础操作——基于Akshare存储股票行情数据")                              | [B站地址](https://www.bilibili.com/video/BV1ds4y1p7ew/) | Python对MySQL的基础操作+Akshare免费金融数据介绍使用 |
| 2023.3.13  | T11 SQL高级查询+ Pandas分析——Kaggle信贷风控Vintage分析 | [资料获取]("Teaching/T11 SQL高级查询+ Pandas分析——Kaggle信贷风控Vintage分析")                        | [B站地址](https://www.bilibili.com/video/BV1h84y1A7sM)  | SQL高级查询语法+信贷风控分析场景介绍                |
